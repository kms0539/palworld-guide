...
test("every registered public dataset exists and matches its schema contract", async () => {
  ...
  assert.deepEqual(
    ...
    ["activities", "breeding", "community-tips", "endgame-reference-1-0-3", "guide", "item-localization-report", "items", "map-pois", "pal-details", "patch-report", "trait-names-ko", "traits", "visual-assets"],
  );
